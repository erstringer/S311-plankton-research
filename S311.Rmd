...
ggsave("visuals/100countbiomass.jpg", device = "jpg", dpi = 500)
...
ggsave("visuals/chlaandcopepods", device = "jpg", dpi = 500)
```
...
labs(title = "Chlorophyll-a concentration and biomass of Chaetognaths and Copepods",
       subtitle = "biomass from hundred counts", 
       x = "chlorophyll-a concentration", y = "biomass") + 
  scale_color_manual(values = c("copepod" = "#238a8d", "chaetognath" = "#440154"), name = "") +
  theme_minimal() 
   
ggsave("visuals/chlabiomass.jpg", device = "jpg", dpi = 500) 
```
  ...
  group_by(cope_or_chae) %>%
      ...
      labs(title = "Proportion of Chaetognaths and Copepods",
       ...
       scale_fill_manual(values = c("copepod (herbivorous/ omnivorous)" = "#29af7f", "copepod (carnivorous)" = "#bade28", "chaetognath adult" = "#440154", "chaetognath juvenile" = "#2d718e"), name = "") +
        theme_minimal() 
  ggsave("visuals/proportions.jpg", device = "jpg", dpi = 500)
```
...
ggsave("visuals/chlaconcentrationandsize.jpg", device = "jpg", dpi = 500)
```
